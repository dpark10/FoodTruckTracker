...
//  
//
//  Created by Dylan Bruschi on 4/25/16.
//
//
...
struct YelpAPIConsole {
    var consumerKey = "nF30f57Y37owF8lkT0yunw"
    var consumerSecret = "XLt0Y2vsTUxkQlAMs5FufxNWlB8"
    var accessToken = "euX1y5nJ1dugqyUfuWkXCdzZU9vjHVGf"
    var accessTokenSecret = "P4SREOHeIPOtDElkxYeiCjZun1s"
}
